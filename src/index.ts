...
async function start() {
  ...
  const migrations = [
    ...
    { sql: `CREATE TABLE IF NOT EXISTS features_registry (id VARCHAR(50) PRIMARY KEY, label VARCHAR(100) NOT NULL, type VARCHAR(20) NOT NULL DEFAULT 'boolean', options JSONB DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, is_active BOOLEAN NOT NULL DEFAULT TRUE, created_at TIMESTAMP DEFAULT ${_SQL_NOW}, updated_at TIMESTAMP DEFAULT ${_SQL_NOW})`, name: 'features_registry' },
