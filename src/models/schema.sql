...
-- ============================================================
-- 11. Inline Tag Editing columns (TZ_INLINE_TAG_EDIT_v2)
-- ============================================================
...
DROP TRIGGER IF EXISTS update_user_defined_tags_updated_at ON user_defined_tags;
CREATE TRIGGER update_user_defined_tags_updated_at
  BEFORE UPDATE ON user_defined_tags
  FOR EACH ROW
