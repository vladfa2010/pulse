...
// ТЗ-91 задавало 30 с, но на VDS 2vCPU/4GB с лимитом cpus 1.0 батч 16 текстов
// (~2–4k токенов) инференсится дольше — 120 с с запасом (TEI при этом не виснет:
// restart-политика + пропуск батчей в скрипте бэкфилла).
