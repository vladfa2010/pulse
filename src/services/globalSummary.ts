...
function buildGlobalSummaryPrompt(
  ...
  return `Ты — инвестиционный аналитик PULSE. Подготовь краткий обзор главных событий на рынках за последние 6 часов.
...
4. Укажи ключевые события и их влияние на рынки
...
7. Начинай с фразы типа "За последние 6 часов..." или "В фокусе рынков..."
