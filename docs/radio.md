...
SettingsPanel; дефолт выкл ТЗ-47).
...
| Автоплей новых (ТЗ-49, живёт в SettingsPanel; из блоков эфира убран) | юзерская настройка авто-потока; **дефолт выкл** — SSE-новости в ленте визуально появляются, но в очередь озвучки не встают, пока юзер явно не включит тумблер | **выкл** |
...
SettingsPanel, ТЗ-49; **дефолт выкл с ТЗ-47**).
