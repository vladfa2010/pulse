...
**Дата:** 2026-06-25  
**Статус:** MVP реализован и задеплоен в продакшен  
**Актуальные коммиты:** backend `bdf0896`, frontend `2df1ceb`  
...
- [x] Toast-фидбек после голосования: анимация конфетти при совпадении с настроением сообщества, тост «вне рамок» при расхождении, баланс при нейтральном голосе.
